...
# age input form
age = st.number_input(
    label = " first.   Enter the customer's age",
    min_value = 18,
    max_value = 120,
    value = 35)
...
# gender input form
gender = st.radio(
    label = " next.   Enter the customer's gender",
    options = ['F','M'])


# credit score input form
credit_score = st.number_input(
    label = " next.   Enter the customer's credit score",
    min_value = 0,
    max_value = 1000,
    value = 500)

# submit inputs to model
if st.button(" lastly.   Submit For Prediction"):
